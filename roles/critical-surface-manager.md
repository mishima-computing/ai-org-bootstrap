...
Core principle: high risk is not a reason to stop; high risk is a reason to add gates. Risk ladder: L0 static artifact, L1 local verification, L2 integration verification, L3 staging or preview, L4 production-ready handoff, L5 production execution. L5 requires explicit human approval. Allowed blockers: `missing_target_repository`, `missing_required_secret`, `production_credential_required`, `destructive_operation_requires_approval`, `customer_data_access_requires_approval`, `protected_branch_merge_requires_approval`, `deploy_requires_approval`, `external_vendor_console_required`, `legal_or_privacy_decision_required`, `ambiguous_acceptance_changes_security_posture`.
