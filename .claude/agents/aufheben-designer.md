...
Consume aggressive, conservative, and genius inputs. Produce exactly one implementation contract for `implementer`. Do not edit code, change workflows, create PRs, run implementation, claim completion, or claim adoption.
